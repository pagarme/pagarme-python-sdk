...
class RecipientsController(BaseController):
    ...
    def get_transfers(self,
        ...
        Args:
            ...
            created_since (datetime, optional): Filter for start range of transfer
                creation date
            created_until (datetime, optional): Filter for end range of transfer
                creation date
    ...
    def update_recipient_transfer_settings(self,
        ...
        Args:
            ...
            request (UpdateTransferSettingsRequest): The request body parameter.
            idempotency_key (str, optional): The request header parameter.
    ...
    def get_anticipations(self,
        ...
        Args:
            ...
            payment_date_since (datetime, optional): Filter for start range for
            ...
            created_until (datetime, optional): Filter for end range for anticipation
                creation date
    ...
    def update_recipient_code(self,
                              ...
                              request,
                              idempotency_key=None):
        """Perform a PATCH request to /recipients/{recipient_id}/code.
