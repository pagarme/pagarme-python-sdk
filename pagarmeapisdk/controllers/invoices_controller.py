...
class InvoicesController(BaseController):
    ...
    def update_invoice_metadata(self,
        ...
        Args:
            ...
            request (UpdateMetadataRequest): Request for updating the invoice metadata
    ...
    def create_invoice(self,
        ...
        Args:
            ...
            request (CreateInvoiceRequest, optional): The request body parameter.
            idempotency_key (str, optional): The request header parameter.
    ...
    def get_invoices(self,
        ...
        Args:
            ...
            subscription_id (str, optional): Filter for Invoice's subscription id
            created_since (datetime, optional): Filter for Invoice's creation date
                start range
            created_until (datetime, optional): Filter for Invoices creation date end
                range
            status (str, optional): Filter for Invoice's status
            due_since (datetime, optional): Filter for Invoice's due date start range
            due_until (datetime, optional): Filter for Invoice's due date end range
    ...
    def update_invoice_status(self,
        ...
        Args:
            invoice_id (str): Invoice Id
            request (UpdateInvoiceStatusRequest): Request for updating an invoice's
                status
            idempotency_key (str, optional): The request header parameter.
