...
class SubscriptionsController(BaseController):
    ...
    def update_subscription_card(self,
        ...
        Args:
            ...
            request (UpdateSubscriptionCardRequest): Request for updating a card
            idempotency_key (str, optional): The request header parameter.
    ...
    def update_current_cycle_status(self,
        ...
        Args:
            subscription_id (str): Subscription Id
            request (UpdateCurrentCycleStatusRequest): Request for updating the end
                date of the subscription current status
            idempotency_key (str, optional): The request header parameter.
    ...
    def get_subscription_items(self,
        ...
        Args:
            ...
            created_since (str, optional): Filter for item's creation date start range
            created_until (str, optional): Filter for item's creation date end range
    ...
    def update_subscription_payment_method(self,
        ...
        Args:
            subscription_id (str): Subscription id
            request (UpdateSubscriptionPaymentMethodRequest): Request for updating
                the paymentmethod from a subscription
            idempotency_key (str, optional): The request header parameter.
    ...
    def get_subscriptions(self,
        ...
        Args:
            ...
            billing_type (str, optional): Filter for subscription's billing type
            ...
            next_billing_since (datetime, optional): Filter for subscription's next
                billing date start range
            next_billing_until (datetime, optional): Filter for subscription's next
                billing date end range
            created_since (datetime, optional): Filter for subscription's creation
                date start range
            created_until (datetime, optional): Filter for subscriptions creation
                date end range
    ...
    def create_subscription(self,
        ...
        Args:
            body (CreateSubscriptionRequest): Request for creating a subscription
            idempotency_key (str, optional): The request header parameter.
    ...
    def update_subscription_affiliation_id(self,
        ...
        Args:
            subscription_id (str): The request template parameter.
            request (UpdateSubscriptionAffiliationIdRequest): Request for updating a
                subscription affiliation id
            idempotency_key (str, optional): The request header parameter.
    ...
    def update_subscription_metadata(self,
        ...
        Args:
            subscription_id (str): The subscription id
            request (UpdateMetadataRequest): Request for updating the subscrption
                metadata
            idempotency_key (str, optional): The request header parameter.
    ...
    def update_subscription_billing_date(self,
        ...
        Args:
            subscription_id (str): The subscription id
            request (UpdateSubscriptionBillingDateRequest): Request for updating the
    ...
    def update_subscription_due_days(self,
        ...
        Args:
            subscription_id (str): Subscription Id
            request (UpdateSubscriptionDueDaysRequest): The request body parameter.
            idempotency_key (str, optional): The request header parameter.
    ...
    def update_subscription_start_at(self,
        ...
        Args:
            subscription_id (str): The subscription id
            request (UpdateSubscriptionStartAtRequest): Request for updating the
    ...
    def update_subscription_item(self,
        ...
        Args:
            subscription_id (str): Subscription Id
            item_id (str): Item id
            body (UpdateSubscriptionItemRequest): Request for updating a subscription
                item
            idempotency_key (str, optional): The request header parameter.
    ...
    def update_latest_period_end_at(self,
        ...
        Args:
            subscription_id (str): The request template parameter.
            request (UpdateCurrentCycleEndDateRequest): Request for updating the end
                date of the current signature cycle
            idempotency_key (str, optional): The request header parameter.
    ...
    def update_subscription_minium_price(self,
        ...
        Args:
            subscription_id (str): Subscription Id
            request (UpdateSubscriptionMinimumPriceRequest): Request da requisição
                com o valor mínimo que será configurado
            idempotency_key (str, optional): The request header parameter.
    ...
    def update_split_subscription(self,
        ...
        Args:
            ...
            request (UpdateSubscriptionSplitRequest): The request body parameter.
