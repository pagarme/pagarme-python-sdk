...
class ChargesController(BaseController):
    ...
    def update_charge_metadata(self,
        ...
        Args:
            ...
            request (UpdateMetadataRequest): Request for updating the charge metadata
    ...
    def update_charge_payment_method(self,
        ...
        Args:
            ...
            request (UpdateChargePaymentMethodRequest): Request for updating the
    ...
    def update_charge_due_date(self,
        ...
        Args:
            charge_id (str): Charge Id
            request (UpdateChargeDueDateRequest): Request for updating the due date
            idempotency_key (str, optional): The request header parameter.
    ...
    def get_charges(self,
        ...
        Args:
            ...
            created_since (datetime, optional): Filter for the beginning of the range
                for charge's creation
            created_until (datetime, optional): Filter for the end of the range for
                charge's creation
    ...
    def capture_charge(self,
        ...
        Args:
            charge_id (str): Charge id
            request (CreateCaptureChargeRequest, optional): Request for capturing a
                charge
            idempotency_key (str, optional): The request header parameter.
    ...
    def update_charge_card(self,
        ...
        Args:
            charge_id (str): Charge id
            request (UpdateChargeCardRequest): Request for updating a charge's card
            idempotency_key (str, optional): The request header parameter.
    ...
    def cancel_charge(self,
        ...
        Args:
            charge_id (str): Charge id
            request (CreateCancelChargeRequest, optional): Request for cancelling a
                charge
            idempotency_key (str, optional): The request header parameter.
    ...
    def confirm_payment(self,
        ...
        Args:
            ...
            request (CreateConfirmPaymentRequest, optional): Request for confirm
                payment
            idempotency_key (str, optional): The request header parameter.
