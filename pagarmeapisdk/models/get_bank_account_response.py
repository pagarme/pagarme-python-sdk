...
class GetBankAccountResponse(object):
    ...
    def from_dictionary(cls,
        ...
        holder_type =\
            ...
            if "holder_type" in dictionary.keys()\
                else APIHelper.SKIP
        bank =\
            dictionary.get("bank")\
        ...
        branch_number =\
            ...
            if "branch_number" in dictionary.keys()\
                else APIHelper.SKIP
        branch_check_digit =\
        ...
        account_check_digit =\
            ...
            if "account_check_digit" in dictionary.keys()\
                else APIHelper.SKIP
        mtype =\
            dictionary.get("type")\
    ...
    def __repr__(self):
        ...
        _account_check_digit=(
            self.account_check_digit
            if hasattr(self, "account_check_digit")
            else None
        )
        _mtype=(
            self.mtype
