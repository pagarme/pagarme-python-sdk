...
"""
from pagarmeapisdk.models.create_seller_request import CreateSellerRequest
...
class CreateOrderItemRequest(object):
    ...
    def from_dictionary(cls,
        ...
        seller = CreateSellerRequest.from_dictionary(dictionary.get('seller')) if dictionary.get('seller') else None
