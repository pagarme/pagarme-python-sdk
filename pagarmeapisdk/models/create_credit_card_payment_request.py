...
class CreateCreditCardPaymentRequest(object):
    ...
    Attributes:
        ...
        statement_descriptor (str): The text that will be shown on the credit card's
            statement
        ...
        contactless (CreateCardPaymentContactlessRequest): The Credit card payment
            contactless request
        auto_recovery (bool): Indicates whether a particular payment will enter the
            offline retry flow
    ...
    def from_dictionary(cls,
        ...
        contactless =\
            CreateCardPaymentContactlessRequest.from_dictionary(
                ...
                if "contactless" in dictionary.keys()\
                else APIHelper.SKIP
        auto_recovery =\
            dictionary.get("auto_recovery")\
            if "auto_recovery" in dictionary.keys()\
                else APIHelper.SKIP
        operation_type =\
            dictionary.get("operation_type")\
            if dictionary.get("operation_type")\
                else APIHelper.SKIP
        recurrency_cycle =\
        ...
        payload =\
            CreateCardPayloadRequest.from_dictionary(
    ...
    def __repr__(self):
        ...
        return (
            ...
            f"contactless={_contactless!r}, "
            f"auto_recovery={_auto_recovery!r}, "
    ...
    def __str__(self):
        ...
        return (
            ...
            f"contactless={_contactless!s}, "
            f"auto_recovery={_auto_recovery!s}, "
