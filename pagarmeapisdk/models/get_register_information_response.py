...
class GetRegisterInformationResponse(object):
    ...
    Attributes:
        ...
        main_address (GetRegisterInformationAddressResponse): The model property of
            type GetRegisterInformationAddressResponse.
        managing_partners (List[GetManagingPartnerResponse]): The model property of
            type List[GetManagingPartnerResponse].
    ...
    def from_dictionary(cls,
        ...
        trading_name =\
            ...
            if "trading_name" in dictionary.keys()\
                else APIHelper.SKIP
        annual_revenue =\
            dictionary.get("annual_revenue")\
            if "annual_revenue" in dictionary.keys()\
                else APIHelper.SKIP
        corporation_type =\
        ...
        if "managing_partners" in dictionary.keys():
            managing_partners = [
                GetManagingPartnerResponse.from_dictionary(x)
                for x in dictionary.get("managing_partners")
            ] if dictionary.get("managing_partners") else None
        else:
            managing_partners = APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        _trading_name=(
            self.trading_name
            if hasattr(self, "trading_name")
            else None
        )
        _annual_revenue=(
            self.annual_revenue
            if hasattr(self, "annual_revenue")
            else None
        )
        _corporation_type=(
        ...
        _main_address=(
            self.main_address
            if hasattr(self, "main_address")
            else None
        )
        _managing_partners=(
            self.managing_partners
            if hasattr(self, "managing_partners")
            else None
        )
        return (
