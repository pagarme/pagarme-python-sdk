...
class GetSubscriptionResponse(object):
    ...
    def from_dictionary(cls,
        ...
        if "current_cycle" in dictionary.keys():
            current_cycle =\
                ...
                dictionary.get("current_cycle"))\
                if dictionary.get("current_cycle") else None
        else:
            current_cycle = APIHelper.SKIP
        payment_method =\
        ...
        if "items" in dictionary.keys():
            items = [
                GetSubscriptionItemResponse.from_dictionary(x)
        ...
        if "setup" in dictionary.keys():
            setup =\
                GetSetupResponse.from_dictionary(
                dictionary.get("setup"))\
                if dictionary.get("setup") else None
        else:
            setup = APIHelper.SKIP
        gateway_affiliation_id =\
        ...
        billing_day =\
            ...
            if "billing_day" in dictionary.keys()\
                else APIHelper.SKIP
        minimum_price =\
        ...
        boleto_due_days =\
            ...
            if "boleto_due_days" in dictionary.keys()\
                else APIHelper.SKIP
        if "split" in dictionary.keys():
            split =\
                GetSubscriptionSplitResponse.from_dictionary(
        ...
        if "boleto" in dictionary.keys():
            boleto =\
                GetSubscriptionBoletoResponse.from_dictionary(
        ...
        manual_billing =\
            ...
            if "manual_billing" in dictionary.keys()\
                else APIHelper.SKIP
        indirect_acceptor =\
    ...
    def __repr__(self):
        ...
        _manual_billing=(
            self.manual_billing
            if hasattr(self, "manual_billing")
            else None
        )
        _indirect_acceptor=(
        ...
        return (
            ...
            f"current_cycle={_current_cycle!r}, "
            ...
            f"split={_split!r}, "
            f"boleto={_boleto!r}, "
            f"manual_billing={_manual_billing!r}, "
    ...
    def __str__(self):
        ...
        return (
            ...
            f"current_cycle={_current_cycle!s}, "
            ...
            f"split={_split!s}, "
            f"boleto={_boleto!s}, "
            f"manual_billing={_manual_billing!s}, "
