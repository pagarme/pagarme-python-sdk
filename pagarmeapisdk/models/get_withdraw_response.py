...
class GetWithdrawResponse(object):
    ...
    def __init__(
        ...
        if funding_date is not APIHelper.SKIP:
            self.funding_date =\
                 APIHelper.apply_datetime_converter(
                funding_date, APIHelper.RFC3339DateTime)\
                 if funding_date else None
        if funding_estimated_date is not APIHelper.SKIP:
            self.funding_estimated_date =\
                 APIHelper.apply_datetime_converter(
                funding_estimated_date, APIHelper.RFC3339DateTime)\
                 if funding_estimated_date else None
    ...
    def from_dictionary(cls,
        ...
        if "source" in dictionary.keys():
            source =\
                GetWithdrawSourceResponse.from_dictionary(
        ...
        if "target" in dictionary.keys():
            target =\
                GetWithdrawTargetResponse.from_dictionary(
