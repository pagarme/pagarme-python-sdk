...
class GetCheckoutPaymentResponse(object):
    ...
    Attributes:
        ...
        gateway_affiliation_id (str): Código da afiliação onde o pagamento será
            processado no gateway
        accepted_payment_methods (List[str]): Meios de pagamento aceitos no checkout
        ...
        credit_card (GetCheckoutCreditCardPaymentResponse): Configurações de cartão
            de crédito
        boleto (GetCheckoutBoletoPaymentResponse): Configurações de boleto
        billing_address_editable (bool): Indica se o billing address poderá ser
            editado
        ...
        currency (str): Moeda
        debit_card (GetCheckoutDebitCardPaymentResponse): Configurações de cartão de
            débito
        bank_transfer (GetCheckoutBankTransferPaymentResponse): Bank transfer payment
            response
    ...
    def from_dictionary(cls,
        ...
        default_payment_method =\
            ...
            if "default_payment_method" in dictionary.keys()\
                else APIHelper.SKIP
        success_url =\
        ...
        payment_url =\
            ...
            if "payment_url" in dictionary.keys()\
                else APIHelper.SKIP
        gateway_affiliation_id =\
            dictionary.get("gateway_affiliation_id")\
            if "gateway_affiliation_id" in dictionary.keys()\
                else APIHelper.SKIP
        accepted_payment_methods =\
            dictionary.get("accepted_payment_methods")\
            if "accepted_payment_methods" in dictionary.keys()\
                else APIHelper.SKIP
        status =\
        ...
        skip_checkout_success_page =\
            ...
            if "skip_checkout_success_page" in dictionary.keys()\
                else APIHelper.SKIP
        ...
        customer_editable =\
            ...
            if "customer_editable" in dictionary.keys()\
                else APIHelper.SKIP
        ...
        if "billingaddress" in dictionary.keys():
            billingaddress =\
                ...
                if dictionary.get("billingaddress") else None
        else:
            billingaddress = APIHelper.SKIP
        if "credit_card" in dictionary.keys():
            credit_card =\
                GetCheckoutCreditCardPaymentResponse.from_dictionary(
        ...
        if "boleto" in dictionary.keys():
            boleto =\
                GetCheckoutBoletoPaymentResponse.from_dictionary(
        ...
        billing_address_editable =\
            ...
            if "billing_address_editable" in dictionary.keys()\
                else APIHelper.SKIP
        ...
        if "debit_card" in dictionary.keys():
            debit_card =\
                GetCheckoutDebitCardPaymentResponse.from_dictionary(
        ...
        if "bank_transfer" in dictionary.keys():
            bank_transfer =\
                GetCheckoutBankTransferPaymentResponse.from_dictionary(
        ...
        accepted_brands =\
            ...
            if "accepted_brands" in dictionary.keys()\
                else APIHelper.SKIP
        if "pix" in dictionary.keys():
            pix =\
                GetCheckoutPixPaymentResponse.from_dictionary(
                dictionary.get("pix"))\
                if dictionary.get("pix") else None
        else:
            pix = APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        _default_payment_method=(
            ...
            if hasattr(self, "default_payment_method")
            else None
        )
        _success_url=(
            self.success_url
        ...
        _accepted_payment_methods=(
            ...
            if hasattr(self, "accepted_payment_methods")
            else None
        )
        _status=(
            self.status
        ...
        _skip_checkout_success_page=(
            self.skip_checkout_success_page
            if hasattr(self, "skip_checkout_success_page")
            else None
        )
        _created_at=(
            self.created_at
        ...
        _customer_editable=(
            self.customer_editable
            if hasattr(self, "customer_editable")
            else None
        )
        _customer=(
            self.customer
        ...
        _billingaddress=(
            self.billingaddress
            if hasattr(self, "billingaddress")
            else None
        )
        _credit_card=(
            self.credit_card
        ...
        _billing_address_editable=(
            self.billing_address_editable
            if hasattr(self, "billing_address_editable")
            else None
        )
        _shipping=(
            self.shipping
        ...
        _accepted_brands=(
            ...
            if hasattr(self, "accepted_brands")
            else None
        )
        _pix=(
            self.pix
        ...
        return (
            ...
            f"id={_id!r}, "
            f"amount={_amount!r}, "
            f"default_payment_method={_default_payment_method!r}, "
            f"success_url={_success_url!r}, "
            f"payment_url={_payment_url!r}, "
            f"gateway_affiliation_id={_gateway_affiliation_id!r}, "
            f"accepted_payment_methods={_accepted_payment_methods!r}, "
            f"status={_status!r}, "
            f"skip_checkout_success_page={_skip_checkout_success_page!r}, "
            f"created_at={_created_at!r}, "
            f"updated_at={_updated_at!r}, "
            f"canceled_at={_canceled_at!r}, "
            f"customer_editable={_customer_editable!r}, "
            f"customer={_customer!r}, "
            f"billingaddress={_billingaddress!r}, "
            f"credit_card={_credit_card!r}, "
            f"boleto={_boleto!r}, "
            f"billing_address_editable={_billing_address_editable!r}, "
            ...
            f"accepted_brands={_accepted_brands!r}, "
            f"pix={_pix!r}, "
            f")"
        )
    ...
    def __str__(self):
        ...
        return (
            ...
            f"id={_id!s}, "
            f"amount={_amount!s}, "
            f"default_payment_method={_default_payment_method!s}, "
            f"success_url={_success_url!s}, "
            f"payment_url={_payment_url!s}, "
            f"gateway_affiliation_id={_gateway_affiliation_id!s}, "
            f"accepted_payment_methods={_accepted_payment_methods!s}, "
            f"status={_status!s}, "
            f"skip_checkout_success_page={_skip_checkout_success_page!s}, "
            f"created_at={_created_at!s}, "
            f"updated_at={_updated_at!s}, "
            f"canceled_at={_canceled_at!s}, "
            f"customer_editable={_customer_editable!s}, "
            f"customer={_customer!s}, "
            f"billingaddress={_billingaddress!s}, "
            f"credit_card={_credit_card!s}, "
            f"boleto={_boleto!s}, "
            f"billing_address_editable={_billing_address_editable!s}, "
            ...
            f"accepted_brands={_accepted_brands!s}, "
            f"pix={_pix!s}, "
            f")"
        )
