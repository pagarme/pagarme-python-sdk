...
class ListTransactionsFilesResponse(object):
    ...
    Attributes:
        data (List[GetTransactionReportFileResponse]): The model property of type
            List[GetTransactionReportFileResponse].
    ...
    def from_dictionary(cls,
        ...
        if "data" in dictionary.keys():
            data = [
                GetTransactionReportFileResponse.from_dictionary(x)
