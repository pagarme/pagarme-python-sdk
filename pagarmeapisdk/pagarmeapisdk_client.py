...
class PagarmeapisdkClient(object):
    ...
    @lazy_property
    def plans(self):
        return PlansController(self.config, self.auth_managers)

    @lazy_property
    def subscriptions(self):
        return SubscriptionsController(self.config, self.auth_managers)
    ...
    @lazy_property
    def recipients(self):
        return RecipientsController(self.config, self.auth_managers)
